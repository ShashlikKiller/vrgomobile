export enum Pathology {
    CEREBRAL_PARALYSIS = "Инсульт",
    MULTIPLE_SCLEROSIS = "Инфаркт",
    SPINAL_CORD_INJURE = "Инклюзия",
    STROKE = "Красный нос",
    TRAUMATIC_BRAIN_INJURY = "Мозг рака"
}
        ...
        exercises: [
            {
                ...
                instruction: [
                    ...
                    'Чтобы обеспечить более глубокое растяжение, отведите ногу еще дальше. Чтобы было легче, поднесите ногу ближе к остальному телу'
                ],
            ...
            },
            {
                ...
                instruction: [
                    'Сядьте на край сиденья, поставив обе ступни на землю, затем поочередно поднимайте колени по одному',
                    'Это упражнение для ног позволяет практиковать движения, используемые при ходьбе, без дополнительной нагрузки на суставы'
                ],
            ...
            },
            {
                ...
                instruction: [
                    'Чтобы растянуть подколенные сухожилия, нужно сесть на пол, выпрямить обе ноги перед собой и наклонить тело вперед',
                    'Задержитесь на 30 секунд и повторите'
                ],
        ...
        exercises: [
            {
                description: 'Планка',
                instruction: [
                    'Займите позу для отжиманий, расставив руки чуть шире плеч, а шею на одной линии со спиной. Их голова должна быть направлена вниз, к земле',
                    'Если обычная планка слишком сложна попробуйте на колени, а не на пальцы ног, или на предплечья, а не на руки. Это снизит давление и повысит стабильность, одновременно укрепив ядро', 
            ...
            },
            {
                ...
                instruction: [
                    'Для растяжки плеч следует поднять одну руку и согнуть ее за головой',
                    'Другой рукой осторожно отвести локоть назад, пока не появится напряжение', 
                    'Задержитесь на 20-30 секунд, а затем поменяйте руки'
                ],
            ...
            },
            {
                ...
                instruction: [
                    'Поверните одну руку через грудь и используйте другую руку, чтобы удерживать первую на месте',
                    'Осторожно прижмите руку к телу, чтобы она плотнее обхватила грудь', 
        ...
        exercises: [
            {
                ...
                instruction: [
                    ...
                    'Согнитесь в талии, перенося вес вперед', 
                    'Отталкивайтесь пятками, пока стоите, напрягая квадрицепсы и ягодицы', 
                    'Используйте стул или столешницу для дополнительного равновесия и помощи при стоянии', 
            ...
            },
            {
                ...
                instruction: [
                    'Сядьте на прочный стул, касаясь спиной спинки стула',
                    'Удобно положите руки на ноги', 
                    'Медленно поднимите левую ногу прямо вверх, оставив колено согнутым', 
                    'Задержитесь в таком положении на 10 секунд (или столько, сколько вам удобно), а затем верните ногу на пол', 
            ...
            },
            {
                ...
                instruction: [
                    'Встаньте и держитесь за спинку стула обеими руками для поддержки',
                    'Поднимите пятку назад и попытайтесь коснуться ягодиц. Движение должно происходить в коленном суставе', 
                    'Если вы не можете дотянуться, попросите кого-нибудь осторожно помочь вам руками поднять пятку как можно выше, без дискомфорта', 
                    'Опустите ногу обратно на землю как можно медленнее'
                ],
        ...
        exercises: [
            {
                ...
                instruction: [
                    ...
                    'Возьмите и держите гантели на плечах, запястья смотрят вперед', 
                    'Выдохните, когда вы поднимаете вес вверх, вытягивая руки вертикально', 
            ...
            },
            {
                ...
                instruction: [
                    ...
                    'Слегка откиньтесь назад, напрягая мышцы живота', 
                    'Согните руки в локтях и держите руки вместе перед собой', 
            ...
            },
            {
                ...
                instruction: [
                    ...
                    'Снова широко разведите руки, сводя лопатки вместе', 
